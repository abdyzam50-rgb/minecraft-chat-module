...
export const CHAT_SLANG = [
  ...
  ['wya', 'where you at — asks location or current area'],
  ['iirc / afaik', 'if I recall correctly / as far as I know'],
  ['tldr', 'too long; did not read — a request for or summary of the short version'],
  ['btw / fyi', 'by the way / for your information'],
  ['tysm / np / npp', 'thanks so much / no problem / no problem, with emphasis'],
  ['sry / soz', 'sorry'],
  ['imk', 'in my knowledge — uncommon; usually read from context rather than copied'],
  ['irl / af', 'in real life / as a strong intensifier; do not take af literally'],
  ['lil / smth / sth / sum', 'little / something / something / some'],
  ['prolly / prolly not', 'probably / probably not'],
  ['frl / real talk', 'for real / serious point rather than a joke'],
  ['ate / ate that', 'did something very well; praise'],
  ['let him cook', 'let someone continue because they may be doing well; usually joking'],
  ['its giving', 'it has the vibe of something; usually followed by a comparison'],
  ['yap / yapping', 'talking too much; teasing, not an invitation to write more'],
  ['npc', 'a predictable or generic person; distinct from the SkyBlock vendor meaning'],
  ['sweat / tryhard', 'someone playing very seriously or efficiently; can be praise or teasing'],
  ['clutch / throw / int', 'save a difficult moment / lose one badly / make a costly mistake'],
  ['nerf / buff / meta', 'make weaker / make stronger / currently strongest strategy'],
  ['ggs / go next', 'good games / move on to the next round or attempt'],
  ['vouch / vouched', 'say that a trader or service is trustworthy; never claim one without evidence'],
  ['imma / gonna / wanna / tryna / finna', 'I am going to / going to / want to / trying to / about to; casual contractions'],
  ['lemme / gimme', 'let me / give me'],
  ['coulda / shoulda / woulda', 'could have / should have / would have'],
  ['aint / isnt / dont', 'informal contractions; understand them without correcting the speaker'],
  ['ik / obv', 'I know / obviously'],
  ['ig', 'usually "I guess"; may mean Instagram, so use surrounding context'],
  ['nbs / no bs', 'seriously, no nonsense'],
  ['omg / oml / stg', 'surprise or emphasis; oh my god / oh my lord / swear to god'],
  ['nahhh / brooo / wild', 'strong disbelief, amusement, or frustration; stretched letters add emphasis'],
  ['crazy / insane / diabolical', 'surprising, impressive, or unreasonable; often exaggerated and not literal'],
  ['peak / scuffed / janky', 'excellent or very typical / awkward or low-quality / unreliable or awkward'],
  ['banger / fire / heat', 'very good, enjoyable, or impressive'],
  ['moot / mutual', 'a mutual follow or acquaintance; uncommon in in-game chat'],
  ['hmu', 'hit me up — contact or invite me later'],
  ['lmk if', 'let me know if; an offer or request for an update'],
  ['dc / disc', 'disconnect or Discord; context decides which'],
  ['ping / lag / fps', 'network delay / network slowdown / frames per second'],
  ['alt / main / smurf', 'secondary account / primary account / experienced player on a low-level account'],
  ['queue / q', 'join or wait for a game queue; not a question by itself'],
  ['nt / nice try', 'sympathy after a failed attempt'],
  ['mbs', 'my bad, plural or emphatic; an apology'],
  ['W mans / W move', 'praise for a person or decision'],
  ['L take / bad take', 'disagreement with an opinion; avoid escalating it into a personal insult'],
  ['touch grass', 'teasing someone for playing too much; do not use as a real-life attack'],
];
